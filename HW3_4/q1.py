...
ALPHA       = 4.0      # weight for Laplacian term
BETA        = 1.0      # weight for Sobel term
...
def main():
    # 1) Read color image
    bgr, used = load_color(["Bodybone.bmp","./Bodybone.bmp","/mnt/data/Bodybone.bmp","fish.jpg","./fish.jpg","/mnt/data/fish.jpg"])
