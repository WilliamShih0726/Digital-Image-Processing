...
def main():
    ap = argparse.ArgumentParser(description="Q2: Gaussian lowpass shading correction on N1.bmp")
    ap.add_argument("--img", default="./N1.bmp")
    ap.add_argument("--out", default="./outputs_q2")
    ap.add_argument("--K", type=float, default=28.0, help="sigma = min(H,W)/K (smaller blur than Q1)")
    ...
    print(f"[Q2 OK] size={h}x{w}  kernel≈{ksize}  sigma={sigma:.2f}")
